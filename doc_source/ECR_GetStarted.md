...
Get started with Amazon Elastic Container Registry \(Amazon ECR\) by creating a repository in the Amazon ECR console\. The Amazon ECR first run wizard guides you through the process to get started creating your first repository\.
