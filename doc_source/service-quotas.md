...
Amazon Elastic Container Registry \(Amazon ECR\) has integrated with Service Quotas an AWS service that enables you to view and manage your quotas, also referred to as limits, from a central location\. For more information, see [What Is Service Quotas?](https://docs.aws.amazon.com/servicequotas/latest/userguide/intro.html) in the *Service Quotas User Guide*\.

Service Quotas makes it easy to look up the value of all of the Amazon ECR service quotas\.
