...
+ VPC endpoints currently don't support Amazon ECR Public repositories\. Consider using a pull through cache rule to host the public image in a private repository in the same Region as the VPC endpoint\. For more information, see [Using pull through cache rules](pull-through-cache.md)\.
